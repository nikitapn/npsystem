...
export class ServerControl extends NPRPC.ObjectProxy {
  public static get servant_t(): new() => _IServerControl_Servant {
    return _IServerControl_Servant;
  }
...
export interface IServerControl_Servant
{
  Shutdown(): void;
}
export class _IServerControl_Servant extends NPRPC.ObjectServant {
  public static _get_class(): string { return "test/test.ServerControl"; }
  public readonly get_class = () => { return _IServerControl_Servant._get_class(); }
  public readonly dispatch = (buf: NPRPC.FlatBuffer, remote_endpoint: NPRPC.EndPoint, from_parent: boolean) => {
    _IServerControl_Servant._dispatch(this, buf, remote_endpoint, from_parent);
  }
  static _dispatch(obj: _IServerControl_Servant, buf: NPRPC.FlatBuffer, remote_endpoint: NPRPC.EndPoint, from_parent: boolean): void {
    let __ch = new NPRPC.impl.Flat_nprpc_base.CallHeader_Direct(buf, 16);
...
export class TestBasic extends NPRPC.ObjectProxy {
  ...
  public async Out(a: /*out*/NPRPC.ref<number>, b: /*out*/NPRPC.ref<boolean>, c: /*out*/NPRPC.ref<Array<number>>): Promise<void> {
    let interface_idx = (arguments.length == 3 ? 0 : arguments[arguments.length - 1]);
    let buf = NPRPC.FlatBuffer.create();
    buf.prepare(32);
    buf.commit(32);
...
export class TestOptional extends NPRPC.ObjectProxy {
  ...
  public async OutEmpty(a: /*out*/NPRPC.ref<number>): Promise<void> {
    let interface_idx = (arguments.length == 1 ? 0 : arguments[arguments.length - 1]);
    let buf = NPRPC.FlatBuffer.create();
    buf.prepare(32);
    buf.commit(32);
    ...
    {
      if (out._1.has_value) {
        a.value = out._1.value
      } else {
        a.value = undefined
      }
    }
  }
  public async Out(a: /*out*/NPRPC.ref<number>): Promise<void> {
    let interface_idx = (arguments.length == 1 ? 0 : arguments[arguments.length - 1]);
    let buf = NPRPC.FlatBuffer.create();
    buf.prepare(32);
    buf.commit(32);
...
export class TestNested extends NPRPC.ObjectProxy {
  ...
  public async Out(a: /*out*/NPRPC.ref<BBB>): Promise<void> {
    let interface_idx = (arguments.length == 1 ? 0 : arguments[arguments.length - 1]);
    let buf = NPRPC.FlatBuffer.create();
    buf.prepare(32);
    buf.commit(32);
    ...
    let out = new Flat_test.test_M5_Direct(buf, 16);
    {
      ...
      if (opt.has_value) {
        {
          let vv = opt.value.a_d(), index_1 = 0;
          (a.value.a as Array<any>) = new Array<any>(vv.elements_size)
          for (let e of vv) {
            a.value.a[index_1].a = e.a;
            a.value.a[index_1].b = e.b;
            a.value.a[index_1].c = e.c;
            ++index_1;
          }
        }
        {
          let vv = opt.value.b_d(), index_2 = 0;
          (a.value.b as Array<any>) = new Array<any>(vv.elements_size)
          for (let e of vv) {
            a.value.b[index_2].a = e.a;
            a.value.b[index_2].b = e.b;
            {
              if (e.c.has_value) {
                a.value.b[index_2].c = e.c.value
              } else {
                a.value.b[index_2].c = undefined
              }
            }
            ++index_2;
          }
