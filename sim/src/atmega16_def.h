...
struct Atmega16
{
	static constexpr auto CHIP = MC_ATMEGA16;
	static constexpr int FLASH_SIZE = 0x4000;
	...
	static constexpr int PINA = 0x39;
	static constexpr int DDRA = 0x3A;
	static constexpr int PORTA = 0x3B;
	...
	static constexpr int OCR0 = 0x5C;
	static constexpr int SPL = 0x5D;
	static constexpr int SPH = 0x5E;
	static constexpr int SREG = 0x5F;

	// Interrupts
	static constexpr int External_Interrupt_Request_0 = 0x002;
	static constexpr int External_Interrupt_Request_1 = 0x004;
	static constexpr int TimerCounter2_Compare_Match = 0x006;
	static constexpr int TimerCounter2_Overflow = 0x008;
	static constexpr int TimerCounter1_Capture_Event = 0x00A;
	static constexpr int TimerCounter1_Compare_Match_A = 0x00C;
	static constexpr int TimerCounter1_Compare_Match_B = 0x00E;
	static constexpr int TimerCounter1_Overflow = 0x010;
	static constexpr int TimerCounter0_Overflow = 0x012;
	static constexpr int Serial_Transfer_Complete = 0x014;
	static constexpr int USART_Rx_Complete = 0x016;
	static constexpr int USART_Data_Register_Empty = 0x018;
	static constexpr int USART_Tx_Complete = 0x01A;
	static constexpr int ADC_Conversion_Complete = 0x01C;
	static constexpr int EEPROM_Ready = 0x01E;
	static constexpr int Analog_Comparator = 0x020;
	static constexpr int TwoWire_Serial_Interface = 0x022;
	static constexpr int External_Interrupt_Request_2 = 0x024;
	static constexpr int TimerCounter0_Compare_Match = 0x026;
	static constexpr int Store_Program_Memory_Ready = 0x028;
	...
	//static constexpr int PINA= _SFR_IO8(0x19)
	static constexpr int PINA0 = 0;
	static constexpr int PINA1 = 1;
	static constexpr int PINA2 = 2;
	static constexpr int PINA3 = 3;
	static constexpr int PINA4 = 4;
	static constexpr int PINA5 = 5;
	static constexpr int PINA6 = 6;
	static constexpr int PINA7 = 7;

	//static constexpr int DDRA= _SFR_IO8(0x1A)
	static constexpr int DDA0 = 0;
	static constexpr int DDA1 = 1;
	static constexpr int DDA2 = 2;
	static constexpr int DDA3 = 3;
	static constexpr int DDA4 = 4;
	static constexpr int DDA5 = 5;
	static constexpr int DDA6 = 6;
	static constexpr int DDA7 = 7;

	//static constexpr int PORTA=_SFR_IO8(0x1B)
	static constexpr int PA0 = 0;
	static constexpr int PA1 = 1;
	static constexpr int PA2 = 2;
	static constexpr int PA3 = 3;
	static constexpr int PA4 = 4;
	static constexpr int PA5 = 5;
	static constexpr int PA6 = 6;
	static constexpr int PA7 = 7;
	...
	*/
	...
	static constexpr int ADTS0 = 5;
	static constexpr int ADTS1 = 6;
	static constexpr int ADTS2 = 7;
	...
	static constexpr int WGM01 = 3;
	static constexpr int COM00 = 4;
	static constexpr int COM01 = 5;
	static constexpr int WGM00 = 6;
	static constexpr int FOC0 = 7;
	...
	static constexpr int INT2 = 5;
	static constexpr int INT0 = 6;
	static constexpr int INT1 = 7;
	/*
	static constexpr char io_registers[][10] =
	{
		{ "TWBR" },
		{ "TWSR" },
		{ "TWAR" },
