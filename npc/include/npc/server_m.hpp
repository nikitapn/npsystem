...
public:
  ...
  void _3(size_t elements_size) { new (&base()._3) ::flat::Vector<uint8_t>(buffer_, elements_size); }
  auto _3_vd() noexcept { return ::flat::Vector_Direct1<uint8_t>(buffer_, offset_ + offsetof(server_M17, _3)); }
  auto _3() noexcept { return (::flat::Span<uint8_t>)base()._3; }
};
} // namespace flat
...
public:
  void* __data() noexcept { return (void*)&base(); }
  server_M19_Direct(boost::beast::flat_buffer& buffer, size_t offset)
    : buffer_(buffer)
    , offset_(offset)
  {
  }
  void _1(size_t elements_size) { new (&base()._1) ::flat::Vector<uint16_t>(buffer_, elements_size); }
  auto _1_vd() noexcept { return ::flat::Vector_Direct1<uint16_t>(buffer_, offset_ + offsetof(server_M19, _1)); }
