var app = (function () {
    ...
    /* src/gui/Gauge.svelte generated by Svelte v3.42.1 */
    const file$4 = "src/gui/Gauge.svelte";
    ...
    // (94:2) {#each scale as s}
    function create_each_block$2(ctx) {
    	let line;
    	let text_1;
    	let t_value = /*s*/ ctx[32][3] + "";
    	let t;
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text(t_value);
    			attr_dev(line, "x1", /*s*/ ctx[32][0][0]);
    			attr_dev(line, "y1", /*s*/ ctx[32][0][1]);
    			attr_dev(line, "x2", /*s*/ ctx[32][1][0]);
    			attr_dev(line, "y2", /*s*/ ctx[32][1][1]);
    			attr_dev(line, "stroke", "DarkSlateGrey");
    			attr_dev(line, "stroke-width", /*scale_width*/ ctx[8]);
    			add_location(line, file$4, 94, 3, 3485);
    			attr_dev(text_1, "text-anchor", "middle");
    			attr_dev(text_1, "class", "scale_text svelte-5j7pgz");
    			attr_dev(text_1, "x", /*s*/ ctx[32][2][0]);
    			attr_dev(text_1, "y", /*s*/ ctx[32][2][1]);
    			add_location(text_1, file$4, 95, 3, 3599);
    		},
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			line = svg_element("line");
    			attr_dev(stop0, "offset", "15%");
    			attr_dev(stop0, "stop-color", "LightGrey");
    			add_location(stop0, file$4, 56, 4, 1990);
    			attr_dev(stop1, "offset", "100%");
    			attr_dev(stop1, "stop-color", "LightSkyBlue");
    			add_location(stop1, file$4, 57, 4, 2039);
    			attr_dev(radialGradient, "id", "radial_gradient");
    			add_location(radialGradient, file$4, 55, 3, 1948);
    			add_location(defs, file$4, 54, 2, 1938);
    			attr_dev(circle0, "cx", circle0_cx_value = /*size*/ ctx[0] / 2);
    			attr_dev(circle0, "cy", circle0_cy_value = /*size*/ ctx[0] / 2);
    			attr_dev(circle0, "r", /*R*/ ctx[3]);
    			attr_dev(circle0, "stroke", "black");
    			attr_dev(circle0, "stroke-width", /*border_width*/ ctx[7]);
    			attr_dev(circle0, "fill", "url(#radial_gradient)");
    			add_location(circle0, file$4, 60, 2, 2121);
    			attr_dev(circle1, "cx", circle1_cx_value = /*size*/ ctx[0] / 2);
    			attr_dev(circle1, "cy", circle1_cy_value = /*size*/ ctx[0] / 2);
    			attr_dev(circle1, "r", /*knob_radius*/ ctx[9]);
    			attr_dev(circle1, "fill", "black");
    			add_location(circle1, file$4, 61, 2, 2236);
    			attr_dev(path0, "d", "\n\t\t\tM " + /*begin_coords*/ ctx[11][0][0] + " " + /*begin_coords*/ ctx[11][0][1] + "\n\t\t\tA " + (/*R*/ ctx[3] - /*dl0*/ ctx[4]) + " " + (/*R*/ ctx[3] - /*dl0*/ ctx[4]) + " 0 0 1 " + /*alarm_hi_coords0*/ ctx[12][0][0] + " " + /*alarm_hi_coords0*/ ctx[12][0][1] + "\n\t\t\tL " + /*alarm_hi_coords0*/ ctx[12][1][0] + " " + /*alarm_hi_coords0*/ ctx[12][1][1] + "\n\t\t\tA " + (/*R*/ ctx[3] - /*dl1*/ ctx[5]) + " " + (/*R*/ ctx[3] - /*dl1*/ ctx[5]) + " 0 0 0 " + /*begin_coords*/ ctx[11][1][0] + " " + /*begin_coords*/ ctx[11][1][1] + "\n\t\t\tL " + /*begin_coords*/ ctx[11][0][0] + " " + /*begin_coords*/ ctx[11][0][1] + "\n\t\t\tZ");
    			add_location(path0, file$4, 64, 3, 2345);
    			attr_dev(g0, "stroke", "none");
    			attr_dev(g0, "fill", "springgreen");
    			add_location(g0, file$4, 63, 2, 2305);
    			attr_dev(path1, "d", "\n\t\t\tM " + /*alarm_hi_coords0*/ ctx[12][0][0] + " " + /*alarm_hi_coords0*/ ctx[12][0][1] + "\n\t\t\tA " + (/*R*/ ctx[3] - /*dl0*/ ctx[4]) + " " + (/*R*/ ctx[3] - /*dl0*/ ctx[4]) + " 0 0 1 " + /*alarm_hihi_coords0*/ ctx[13][0][0] + " " + /*alarm_hihi_coords0*/ ctx[13][0][1] + "\n\t\t\tL " + /*alarm_hihi_coords0*/ ctx[13][1][0] + " " + /*alarm_hihi_coords0*/ ctx[13][1][1] + "\n\t\t\tA " + /*R*/ ctx[3] + " " + /*R*/ ctx[3] + " 0 0 0 " + /*alarm_hi_coords0*/ ctx[12][1][0] + " " + /*alarm_hi_coords0*/ ctx[12][1][1] + "\n\t\t\tL " + /*alarm_hi_coords0*/ ctx[12][0][0] + " " + /*alarm_hi_coords0*/ ctx[12][0][1] + "\n\t\t\tZ");
    			add_location(path1, file$4, 74, 3, 2708);
    			attr_dev(g1, "stroke", "none");
    			attr_dev(g1, "fill", "#F5F82F");
    			add_location(g1, file$4, 73, 2, 2672);
    			attr_dev(path2, "d", "\n\t\t\t\tM " + /*alarm_hihi_coords0*/ ctx[13][0][0] + " " + /*alarm_hihi_coords0*/ ctx[13][0][1] + "\n\t\t\t\tA " + (/*R*/ ctx[3] - /*dl0*/ ctx[4]) + " " + (/*R*/ ctx[3] - /*dl0*/ ctx[4]) + " 0 0 1 " + /*alarm_hihi_coords1*/ ctx[14][0][0] + " " + /*alarm_hihi_coords1*/ ctx[14][0][1] + "\n\t\t\t\tL " + /*alarm_hihi_coords1*/ ctx[14][1][0] + " " + /*alarm_hihi_coords1*/ ctx[14][1][1] + "\n\t\t\t\tA " + /*R*/ ctx[3] + " " + /*R*/ ctx[3] + " 0 0 0 " + /*alarm_hihi_coords0*/ ctx[13][1][0] + " " + /*alarm_hihi_coords0*/ ctx[13][1][1] + "\n\t\t\t\tL " + /*alarm_hihi_coords0*/ ctx[13][0][0] + " " + /*alarm_hihi_coords0*/ ctx[13][0][1] + "\n\t\t\t\tZ");
    			add_location(path2, file$4, 84, 4, 3094);
    			attr_dev(g2, "stroke", "none");
    			attr_dev(g2, "fill", "#F8322F");
    			add_location(g2, file$4, 83, 3, 3057);
    			attr_dev(line, "x1", line_x__value = /*size*/ ctx[0] / 2);
    			attr_dev(line, "y1", line_y__value = /*size*/ ctx[0] / 2);
    			attr_dev(line, "x2", /*line_x1*/ ctx[1]);
    			attr_dev(line, "y2", /*line_y1*/ ctx[2]);
    			attr_dev(line, "stroke-width", /*line_width*/ ctx[6]);
    			attr_dev(line, "stroke", "black");
    			add_location(line, file$4, 98, 2, 3697);
    			attr_dev(svg, "width", /*size*/ ctx[0]);
    			attr_dev(svg, "height", /*size*/ ctx[0]);
    			add_location(svg, file$4, 53, 1, 1903);
    			add_location(div, file$4, 52, 0, 1896);
    		},
    		...
    		p: function update(ctx, dirty) {
    			if (dirty[0] & /*size*/ 1 && circle0_cx_value !== (circle0_cx_value = /*size*/ ctx[0] / 2)) {
    				attr_dev(circle0, "cx", circle0_cx_value);
    			}

    			if (dirty[0] & /*size*/ 1 && circle0_cy_value !== (circle0_cy_value = /*size*/ ctx[0] / 2)) {
    				attr_dev(circle0, "cy", circle0_cy_value);
    			}

    			if (dirty[0] & /*size*/ 1 && circle1_cx_value !== (circle1_cx_value = /*size*/ ctx[0] / 2)) {
    				attr_dev(circle1, "cx", circle1_cx_value);
    			}

    			if (dirty[0] & /*size*/ 1 && circle1_cy_value !== (circle1_cy_value = /*size*/ ctx[0] / 2)) {
    				attr_dev(circle1, "cy", circle1_cy_value);
    			}

    			if (dirty[0] & /*scale, scale_width*/ 1280) {
    				each_value = /*scale*/ ctx[10];
    				validate_each_argument(each_value);
    				let i;
    			...
    			if (dirty[0] & /*size*/ 1 && line_x__value !== (line_x__value = /*size*/ ctx[0] / 2)) {
    				attr_dev(line, "x1", line_x__value);
    			}

    			if (dirty[0] & /*size*/ 1 && line_y__value !== (line_y__value = /*size*/ ctx[0] / 2)) {
    				attr_dev(line, "y1", line_y__value);
    			}

    			if (dirty[0] & /*line_x1*/ 2) {
    				attr_dev(line, "x2", /*line_x1*/ ctx[1]);
    			}

    			if (dirty[0] & /*line_y1*/ 4) {
    				attr_dev(line, "y2", /*line_y1*/ ctx[2]);
    			}
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	const scale = new Array(scale_n).fill(0).map((x, ix) => {
    	...
    	beforeUpdate(() => {
    		$$invalidate(1, [line_x1, line_y1] = to_cartesian(to_angle(value), size / 2 - dl00), line_x1, $$invalidate(2, line_y1));
    	});

    	const writable_props = ['size', 'min_val', 'max_val', 'value', 'alarm_hi', 'alarm_hihi'];
    	...
    	$$self.$$set = $$props => {
    		...
    		if ('min_val' in $$props) $$invalidate(15, min_val = $$props.min_val);
    		if ('max_val' in $$props) $$invalidate(16, max_val = $$props.max_val);
    		if ('value' in $$props) $$invalidate(17, value = $$props.value);
    		if ('alarm_hi' in $$props) $$invalidate(18, alarm_hi = $$props.alarm_hi);
    		if ('alarm_hihi' in $$props) $$invalidate(19, alarm_hihi = $$props.alarm_hihi);
    	};
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('alarm_hi' in $$props) $$invalidate(18, alarm_hi = $$props.alarm_hi);
    		if ('alarm_hihi' in $$props) $$invalidate(19, alarm_hihi = $$props.alarm_hihi);
    		if ('line_x1' in $$props) $$invalidate(1, line_x1 = $$props.line_x1);
    		if ('line_y1' in $$props) $$invalidate(2, line_y1 = $$props.line_y1);
    	};
    ...
    class Gauge extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*size*/ ctx[0] === undefined && !('size' in props)) {
    			console.warn("<Gauge> was created without expected prop 'size'");
    		}

    		if (/*min_val*/ ctx[15] === undefined && !('min_val' in props)) {
    			console.warn("<Gauge> was created without expected prop 'min_val'");
    		}

    		if (/*max_val*/ ctx[16] === undefined && !('max_val' in props)) {
    			console.warn("<Gauge> was created without expected prop 'max_val'");
    		}

    		if (/*value*/ ctx[17] === undefined && !('value' in props)) {
    			console.warn("<Gauge> was created without expected prop 'value'");
    		}

    		if (/*alarm_hi*/ ctx[18] === undefined && !('alarm_hi' in props)) {
    			console.warn("<Gauge> was created without expected prop 'alarm_hi'");
    		}

    		if (/*alarm_hihi*/ ctx[19] === undefined && !('alarm_hihi' in props)) {
    			console.warn("<Gauge> was created without expected prop 'alarm_hihi'");
    		}
    	}
    	...
    	set alarm_hihi(value) {
    		throw new Error("<Gauge>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    }

    /* src/gui/Parameter.svelte generated by Svelte v3.42.1 */
    const file$3 = "src/gui/Parameter.svelte";
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "name svelte-19y940p");
    			add_location(div0, file$3, 10, 1, 127);
    			attr_dev(div1, "class", "desc svelte-19y940p");
    			add_location(div1, file$3, 11, 1, 159);
    			attr_dev(div2, "class", "value svelte-19y940p");
    			add_location(div2, file$3, 12, 1, 191);
    			attr_dev(li, "class", "svelte-19y940p");
    			add_location(li, file$3, 9, 0, 121);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(div2, t4);
    			append_dev(li, t5);
    			mount_component(gauge, li, null);
    			current = true;
    		},
    		p: function update(ctx, [dirty]) {
    			if (!current || dirty & /*name*/ 1) set_data_dev(t0, /*name*/ ctx[0]);
    			if (!current || dirty & /*desc*/ 2) set_data_dev(t2, /*desc*/ ctx[1]);
    			if ((!current || dirty & /*$op*/ 8) && t4_value !== (t4_value = /*$op*/ ctx[3].str + "")) set_data_dev(t4, t4_value);
    			const gauge_changes = {};
    			if (dirty & /*$op*/ 8) gauge_changes.value = /*$op*/ ctx[3].value;
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	let $op,
    		$$unsubscribe_op = noop,
    		$$subscribe_op = () => ($$unsubscribe_op(), $$unsubscribe_op = subscribe(op, $$value => $$invalidate(3, $op = $$value)), op);

    	$$self.$$.on_destroy.push(() => $$unsubscribe_op());
    	let { $$slots: slots = {}, $$scope } = $$props;
    	...
    	let { desc } = $$props;
    	let { op } = $$props;
    	validate_store(op, 'op');
    	$$subscribe_op();
    	const writable_props = ['name', 'desc', 'op'];
    	...
    	$$self.$$set = $$props => {
    		...
    		if ('op' in $$props) $$subscribe_op($$invalidate(2, op = $$props.op));
    	};

    	$$self.$capture_state = () => ({ Gauge, name, desc, op, $op });
    	...
    	return [name, desc, op, $op];
    }

    class Parameter extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, { name: 0, desc: 1, op: 2 });
    		...
    		if (/*op*/ ctx[2] === undefined && !('op' in props)) {
    			console.warn("<Parameter> was created without expected prop 'op'");
    		}
    	}
    ...
    /* src/gui/Category.svelte generated by Svelte v3.42.1 */
    const file$2 = "src/gui/Category.svelte";
    ...
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*cat*/ 1) parameter_changes.op = /*param*/ ctx[1].ov.value;
    ...
    /* src/gui/CollapsibleSection.svelte generated by Svelte v3.42.1 */
    const file$1 = "src/gui/CollapsibleSection.svelte";
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 21, 1, 632);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(path0, "class", "vert svelte-1ewqszg");
    			attr_dev(path0, "d", "M10 1V19");
    			attr_dev(path0, "stroke", "black");
    			attr_dev(path0, "stroke-width", "2");
    			add_location(path0, file$1, 15, 4, 460);
    			attr_dev(path1, "d", "M1 10L19 10");
    			attr_dev(path1, "stroke", "black");
    			attr_dev(path1, "stroke-width", "2");
    			add_location(path1, file$1, 16, 4, 530);
    			attr_dev(svg, "viewBox", "0 0 20 20");
    			attr_dev(svg, "fill", "none");
    			attr_dev(svg, "class", "svelte-1ewqszg");
    			add_location(svg, file$1, 14, 3, 417);
    			attr_dev(button, "aria-expanded", /*expanded*/ ctx[0]);
    			attr_dev(button, "class", "svelte-1ewqszg");
    			add_location(button, file$1, 13, 2, 330);
    			attr_dev(h3, "class", "svelte-1ewqszg");
    			add_location(h3, file$1, 12, 1, 323);
    			attr_dev(div, "class", "collapsible svelte-1ewqszg");
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ headerText, expanded, slide, quintOut });
    ...
    class OnlineValue {
        ...
        set_value(val) {
            switch (val.s) {
                case 2 /* VST_UNKNOWN */:
                    this.value.set({ value: null, status: val.s, quality: 0 /* VQ_BAD */, str: "unk" });
                    return;
                case 1 /* VST_DEVICE_NOT_RESPONDED */:
                    this.value.set({ value: null, status: val.s, quality: 0 /* VQ_BAD */, str: "nc" });
                    return;
                case 0 /* VST_DEVICE_RESPONDED */:
                    let value, quality = 1 /* VQ_GOOD */, str;
                    ...
                    switch (clear_type) {
                        case VT.VT_DISCRETE:
                            ...
                            str = (data.data_view.getUint8(0) === 255 /* True */) ? "1" : "0";
                            break;
                        case VT.VT_BYTE:
        ...
        constructor(type) {
            this.type_ = type;
            this.value = writable({ value: 0, status: 2 /* VST_UNKNOWN */, quality: 0, str: "unk" });
        }
    }
    ...
    /* src/gui/App.svelte generated by Svelte v3.42.1 */
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file, 5, 0, 169);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
